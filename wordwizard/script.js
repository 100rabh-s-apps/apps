document.addEventListener('DOMContentLoaded', () => {
    ...
    const allQuestions = {
        wordInContext: [ // Renamed from completeSentence
            { type: 'wordInContext', question: "The cat likes to _____ in the sun.", options: ["run", "sleep", "eat", "jump"], correctAnswer: "sleep" },
            ...
            { type: 'wordInContext', question: "A _____ swims in the ocean.", options: ["bird", "dog", "fish", "cat"], correctAnswer: "fish" },
            { type: 'wordInContext', question: "Please _____ the door when you enter.", options: ["kick", "close", "open", "throw"], correctAnswer: "open" },
            { type: 'wordInContext', question: "I like to _____ books at the library.", options: ["play", "read", "sing", "dance"], correctAnswer: "read" },
            { type: 'wordInContext', question: "The dog likes to _____ in the park.", options: ["swim", "fly", "play", "sleep"], correctAnswer: "play" },
            // Add many, many more wordInContext questions here (aim for 50-100+)
        ],
        matchDefinition: [
            ...
            // Add many, many more matchDefinition questions here (aim for 50-100+)
        ],
        unscrambleWord: [
            ...
            // Add many, many more unscrambleWord questions here (aim for 50-100+)
        ],
        grammarFix: [
            ...
            // Add many, many more grammarFix questions here (aim for 50-100+)
        ]
    };
